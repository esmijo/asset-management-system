...
@section('content')
<h3 style="text-align: center;">My Appointment Calendar</h3>
<hr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="print-details">
          <div class="row">
            <h3 id="clinicName" style="text-align: center">ClinicName</h3>
            <img src="" height="150" width="150" alt="" id="clinicPhoto">
          </div>
          <hr>
          <table class="table table-sm table-hover">
            <tr>
              <td>Patient Name:</td>
              <td>:</td>
              <td><strong id="patientName"></strong></td>
            </tr>
            <tr>
...
<input type="hidden" name="patientID" id="patientID" value="{{ $client->id }}">
